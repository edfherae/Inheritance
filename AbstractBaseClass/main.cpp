...
int main()
{
	...
	Geometry::Rectangle rect(50, 100, 325, 50, 3,  Color::GREEN);
	rect.info();

	Geometry::Circle circle(1, 400, 50, 1, Color::YELLOW);
	circle.info();

	Geometry::EquilateralTriangle eqTriangle(100, 500, 50, 1, Color::RED);
	eqTriangle.info();

	Geometry::IsoscelesTriangle isTriangle(150, 100, 600, 50, 3, Color::GREEN);
	isTriangle.info();

	Geometry::RightTriangle rTriangle(30, 100, 700, 50, 3, Color::BLUE);
	rTriangle.info();
